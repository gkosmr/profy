...
class FacultiesControllerTest < ActionController::TestCase
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post :create, faculty: { address: @faculty.address, name: @faculty.name, short_name: @faculty.short_name, university: @faculty.university }
    end
  ...
  test "should update faculty" do
    patch :update, id: @faculty, faculty: { address: @faculty.address, name: @faculty.name, short_name: @faculty.short_name, university: @faculty.university }
    assert_redirected_to faculty_path(assigns(:faculty))
  end
